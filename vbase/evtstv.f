...
C
C     159  BGMD BEFORE THIN GENERALIZED MEAN DIAMETER (REINEKE'S DIAMETER) -- FEB 2026
C
...
C
C   238  AGMD AFTER THIN GENERALIZED MEAN DIAMETER (REINEKE'S DIAMETER) -- FEB 2026
C
